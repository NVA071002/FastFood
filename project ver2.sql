...
select 1,'VEG.BURGER', 70, 50, BulkColumn from OPENROWSET (BULK 'C:\Users\PC\OneDrive\Hình ảnh\menu\VEG.BURGER.jfif' , Single_Blob) as Picture
insert into Menu (Dish_ID, Dish_Name, Price, Dish_Status, photo)
select 2,'VEG.CHILLY BURGER', 70, 50, BulkColumn from OPENROWSET (BULK 'C:\Users\PC\OneDrive\Hình ảnh\menu\VEG.CHILLY BURGER.jpg' , Single_Blob) as Picture
insert into Menu (Dish_ID, Dish_Name, Price, Dish_Status, photo)
select 3,'CHICKEN BURGER', 110, 50, BulkColumn from OPENROWSET (BULK 'C:\Users\PC\OneDrive\Hình ảnh\menu\CHICKEN BURGER.jfif' , Single_Blob) as Picture
insert into Menu (Dish_ID, Dish_Name, Price, Dish_Status, photo)
select 4,'MUTTON BURGER', 125,50, BulkColumn from OPENROWSET (BULK 'C:\Users\PC\OneDrive\Hình ảnh\menu\MUTTON BURGER.jfif' , Single_Blob) as Picture
insert into Menu (Dish_ID, Dish_Name, Price, Dish_Status, photo)
select 5,'HAM BURGER', 110,50, BulkColumn from OPENROWSET (BULK 'C:\Users\PC\OneDrive\Hình ảnh\menu\HAM BURGER.jfif' , Single_Blob) as Picture
insert into Menu (Dish_ID, Dish_Name, Price, Dish_Status, photo)
select 6,'SALAMI BURGER', 110,50, BulkColumn from OPENROWSET (BULK 'C:\Users\PC\OneDrive\Hình ảnh\menu\SALAMI BURGER.jfif' , Single_Blob) as Picture
insert into Menu (Dish_ID, Dish_Name, Price, Dish_Status, photo)
select 7,'FISH BURGER', 125,50, BulkColumn from OPENROWSET (BULK 'C:\Users\PC\OneDrive\Hình ảnh\menu\FISH BURGER.jfif' , Single_Blob) as Picture
insert into Menu (Dish_ID, Dish_Name, Price, Dish_Status, photo)
select 8,'PIZZA CHEESE', 180,50, BulkColumn from OPENROWSET (BULK 'C:\Users\PC\OneDrive\Hình ảnh\menu\PIZZA CHEESE.jpg' , Single_Blob) as Picture
insert into Menu (Dish_ID, Dish_Name, Price, Dish_Status, photo)
select 9,'PIZZA TOMATO CHEESE', 180,50, BulkColumn from OPENROWSET (BULK 'C:\Users\PC\OneDrive\Hình ảnh\menu\PIZZA TOMATO CHEESE.jpg' , Single_Blob) as Picture
insert into Menu (Dish_ID, Dish_Name, Price, Dish_Status, photo)
select 10,'PIZZA MUSHROOM CHEESE', 210,50, BulkColumn from OPENROWSET (BULK 'C:\Users\PC\OneDrive\Hình ảnh\menu\PIZZA MUSHROOM CHEESE.jpg' , Single_Blob) as Picture
insert into Menu (Dish_ID, Dish_Name, Price, Dish_Status, photo)
select 11,'PIZZA CHICKEN CHEESE', 250,50, BulkColumn from OPENROWSET (BULK 'C:\Users\PC\OneDrive\Hình ảnh\menu\PIZZA CHICKEN CHEESE.jfif' , Single_Blob) as Picture
insert into Menu (Dish_ID, Dish_Name, Price, Dish_Status, photo)
select 12,'PIZZA SAUSAGE', 250,50, BulkColumn from OPENROWSET (BULK 'C:\Users\PC\OneDrive\Hình ảnh\menu\PIZZA SAUSAGE.jfif' , Single_Blob) as Picture
insert into Menu (Dish_ID, Dish_Name, Price, Dish_Status, photo)
select 13,'CHEESE SANDWICH', 130,50, BulkColumn from OPENROWSET (BULK 'C:\Users\PC\OneDrive\Hình ảnh\menu\CHEESE SANDWICH.jfif' , Single_Blob) as Picture
insert into Menu (Dish_ID, Dish_Name, Price, Dish_Status, photo)
select 14,'CHICKEN CHEESE SANDWICH', 145,50, BulkColumn from OPENROWSET (BULK 'C:\Users\PC\OneDrive\Hình ảnh\menu\CHICKEN CHEESE SANDWICH.jpg' , Single_Blob) as Picture
...
as
Begin
	insert into Staff values(@ID, @Staff_Name, @PhoneNumber, @Salary, @Type)
end
